...
const SignUp = () => {
  const sigUpOne = (
    <div className="flex flex-col justify-center items-center h-screen">
      <h1>Sign Up One</h1>
      <input
        className="border-b-2  w-[296px] focus:outline-none border-[#969696]"
        type="text"
  ...
  const signUpThree = (
    <div className="flex flex-col justify-center items-center h-screen">
      <h1>Sign Up One</h1>
      <select className="border-b-2 w-[296px] text-[#969696] focus:outline-none border-[#969696]">
  ...
  const signUpFour = (
    <div className="flex flex-col w-[296px] justify-center items-center h-screen">
      <img src={signupfinal} className="h-[230px] w-[290px]" />
      <p>Congratulations!</p>
      <p className="text-center">Welcome to the Uamuzi family! You can now log in to your account.</p>
      <button
        className="bg-[#8067AD] flex justify-center h-[40px] items-center  text-white w-[296px] p-4 mx-auto rounded-md mt-4"
        style={{
          boxShadow: "0px 8px 16px rgba(128, 103, 173, 0.65)",
  ...
  return (
    <div>
      ...
      >
        <SwiperSlide className="flex items-center justify-center h-[100vh]">
          {sigUpOne}
        </SwiperSlide>
        <SwiperSlide className="flex items-center justify-center h-[100vh]">
          {signUpTwo}
